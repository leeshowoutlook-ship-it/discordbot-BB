...
static const std::vector<HelpPage> HELP_PAGES = {
    ...
    },
    {
        "🪙  籌碼系統",
        {
            ...
            { "!每週領取 / /每週領取",     "每週二08:00(UTC+8)可領取 2000 碼" },
            { "!錢包 / /錢包",             "查看自己籌碼量與統計" },
    ...
    },
    {
        "🎊  活動與管理",
        {
            ...
            { "!記帳 / /記帳",                  "（管理員）查看商店購買記帳本" },
            { "!管理員權限",                    "（擁有者）調整碼數、給予/沒收道具、中斷卡住的遊戲" },
